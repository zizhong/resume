...
\begin{itemize}[parsep=0.5ex]
  \item Programming Languages: C++, C\#, Javascript, PowerShell, Linux shell
...
\role{C\#, Cmdlets, ODB, Azure, NoSQL} { }
SharePoint-Online MultiGeo project changes the basic infrastructure to MultiGeo and implements data move of user content for ODB and tenant data. This is to meet data residency laws,
